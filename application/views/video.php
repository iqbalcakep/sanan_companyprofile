...
<html lang="zxx" class="no-js">
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Post with video - Sanan Tempe</title>
								...
								<div class="feature-img-thumb relative">
									<div class="video-box">
										...
										<div id="thumbnail_container" class="thumbnail_container">
											<img class="img-fluid" id="thumbnail" alt="" src="<?php echo base_url() ?>assets/img/f1.jpg"/>
											<div class="overlay overlay-bg"></div>
										</div>
										<a class="start-video"><img src="<?php echo base_url() ?>assets/img/play-icon.png" alt=""></a>
									</div>
								</div>
