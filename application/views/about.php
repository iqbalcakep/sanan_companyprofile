...
<html lang="zxx" class="no-js">
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>About us - Sanan Tempe</title>
			...
			<div class="container">
				...
				<div class="row feedback-contents justify-content-between align-items-center">
					...
					<div class="col-lg-5 feedback-right relative d-flex justify-content-center align-items-center">
						...
						<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid" src="<?php echo base_url() ?>assets/img/play-btn.png" alt=""></a>
					</div>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="active-testimonial">
						<div class="single-testimonial item d-flex flex-row">
							<div class="thumb">
								<img class="img-fluid" src="<?php echo base_url() ?>assets/img/about/user1.png" alt="">
							</div>
							<div class="desc">
								<p>
						...
						<div class="single-testimonial item d-flex flex-row">
							<div class="thumb">
								<img class="img-fluid" src="<?php echo base_url() ?>assets/img/about/user2.png" alt="">
							</div>
							<div class="desc">
								<p>
