...
<html>
<head>
<title>Edit Berita - Admin Sanan</title>
			...
			<div class="inner-block">
			    <div class="blank">
			    	...
			    	<div class="blankpage-main">
			    		<?php echo form_open_multipart('admin/berita/edit/1'); ?>
				        <?php echo validation_errors(); ?>

				        <div class="form-group">
				        	<input type="hidden" name="id_berita" value="<?php echo $berita[0]->id_berita ?>">
				            <label for="">Judul Berita</label>
				            <input type="text" class="form-control" id="judul_berita" name="judul_berita" placeholder="Judul Berita" value="<?php echo $berita[0]->judul_berita ?>"><br>

				            <label for="">Berita</label>
				            <textarea class="form-control" id="editor1" name="isi_berita" placeholder="Isi_berita"><?php echo $berita[0]->isi_berita ?></textarea>
				            <br>
